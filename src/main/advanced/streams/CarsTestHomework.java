...
public class CarsTestHomework {
    ...
    public void get_a_list_with_car_counts_for_each_CarProducer(){
        //TODO
        // 1. steps get car producers
        // 2. write a function that receives a list of cars and a car producers
        // and returns the count of cars for that producer
        // 3. stream car producers collection and map each producer with the function created at step 2
    }
